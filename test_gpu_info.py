...
def get_gpu_info():
    ...
    table.add_row("Max Threads per SM", str(device_props.max_threads_per_sm))
    table.add_row("Max Shared Memory per SM", f"{device_props.max_shared_memory_per_sm / 1024:.1f} KB")
