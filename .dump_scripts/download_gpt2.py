...
def download_gpt2():
    """Download GPT2-small model and tokenizer with progress indication"""
    model_name = "gpt2"
    
    console.print(f"[cyan]Downloading {model_name}...[/cyan]")
    console.print("[yellow]This will download approximately 500MB of data[/yellow]")
    ...
    console.print("[green]✓ GPT2-small model downloaded successfully![/green]")
